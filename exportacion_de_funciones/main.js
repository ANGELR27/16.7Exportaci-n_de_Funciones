...
import { sumar, restar, multiplicar, areaCirculo } from './operaciones-matematicas.js'; // importaciones ejercicio 2
...
console.log(`Un producto de $${precioProducto} con 19% de IVA cuesta: $${precioConIva}`);
